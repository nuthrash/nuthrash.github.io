...
([, , , , , , , , function (e, t, n) {
			...
			var r = c("_blazorLogicalChildren"),
			o = c("_blazorLogicalParent"),
			a = c("_blazorLogicalEnd");
			function i(e, t) {
				...
				if (n < i.length) {
					...
					i.splice(n, 0, a)
						...
						if (n instanceof Element)
							...
							var r = (a = s(l(o = n)), i = Array.prototype.indexOf.call(a, o), a[i + 1] || null);
							r ? r.parentNode.insertBefore(t, r) : e(t, l(n))
						}
						var o,
						a,
						i
			...
			!function (e) {
				...
				e.jsCallDispatcher = {
					...
					beginInvokeJSFromDotNet: function (e, t, n) {
						...
						e && r.then(function (t) {
							return c().beginInvokeDotNetFromJS(0, "Microsoft.JSInterop", "DotNetDispatcher.EndInvoke", null, JSON.stringify([e, !0, t], v))
						}, function (t) {
			...
			function c() {
				return r(this, void 0, void 0, function () {
					return o(this, function (e) {
						switch (e.label) {
						case 0:
							return u ? [4, DotNet.invokeMethodAsync(u.assemblyName, u.functionName, location.href)] : [3, 2];
						case 1:
							e.sent(),
							e.label = 2;
						case 2:
			...
			f = function () {
				...
				e.prototype.applyEdits = function (e, t, n, o, i) {
					for (var u = 0, l = n, s = e.arraySegmentReader, c = e.editReader, f = e.frameReader, d = s.values(o), p = s.offset(o), m = p + s.count(o), h = p; h < m; h++) {
						var y = e.diffReader.editsEntry(d, h),
						v = c.editType(y);
						switch (v) {
						case r.EditType.prependFrame:
							var g = c.newTreeIndex(y),
							b = e.referenceFramesEntry(i, g),
							w = c.siblingIndex(y);
							this.insertFrame(e, t, l + w, i, b, g);
							break;
						case r.EditType.removeFrame:
							w = c.siblingIndex(y);
							a.removeLogicalChild(t, l + w);
							break;
						case r.EditType.setAttribute:
							g = c.newTreeIndex(y),
							b = e.referenceFramesEntry(i, g),
							w = c.siblingIndex(y);
							if (!((E = a.getLogicalChild(t, l + w))instanceof Element))
						...
						case r.EditType.removeAttribute:
							var E;
							w = c.siblingIndex(y);
							if (!((E = a.getLogicalChild(t, l + w))instanceof HTMLElement))
								throw new Error("Cannot remove attribute from non-element child");
							var _ = c.removedAttributeName(y);
							this.tryApplySpecialProperty(e, E, _, null) || E.removeAttribute(_);
							break;
						case r.EditType.updateText:
							g = c.newTreeIndex(y),
							b = e.referenceFramesEntry(i, g),
							w = c.siblingIndex(y);
							var S = a.getLogicalChild(t, l + w);
							if (!(S instanceof Text))
								throw new Error("Cannot set text content on non-text child");
							S.textContent = f.textContent(b);
							break;
						case r.EditType.updateMarkup:
							...
							w = c.siblingIndex(y);
							a.removeLogicalChild(t, l + w),
							this.insertMarkup(e, t, l + w, b);
							break;
						case r.EditType.stepIn:
							w = c.siblingIndex(y);
							t = a.getLogicalChild(t, l + w),
							u++,
							l = 0;
							break;
				...
				e.prototype.insertFrame = function (e, t, n, o, a, u) {
					...
					case r.FrameType.elementReferenceCapture:
						if (t instanceof Element)
							return i.applyCaptureIdToElement(t, l.elementReferenceCaptureId(a)), 0;
				...
				e.prototype.insertMarkup = function (e, t, n, r) {
					for (var o, i = a.createAndInsertLogicalContainer(t, n), s = e.frameReader.markupContent(r), c = (o = s, a.isSvgElement(t) ? (l.innerHTML = o || " ", l) : (u.innerHTML = o || " ", u.content)), f = 0; c.firstChild; )
						a.insertLogicalChild(c.firstChild, i, f++)
				},
				e.prototype.applyAttribute = function (e, t, n) {
					var r = e.frameReader,
					o = r.attributeName(n),
					a = (this.browserRendererId, r.attributeEventHandlerId(n));
					if (a) {
			...
			var r,
			o = n(26),
			a = (r = {}, ["abort", "blur", "change", "error", "focus", "load", "loadend", "loadstart", "mouseenter", "mouseleave", "progress", "reset", "scroll", "submit", "unload", "DOMNodeInsertedIntoDocument", "DOMNodeRemovedFromDocument"].forEach(function (e) {
					r[e] = !0
				}), r),
			i = function () {
				function e(t) {
							...
							d.preRun.push(function () {
								...
								e.forEach(function (e) {
									...
									(e).then(function (o) {
										...
										t(n, i, o.length),
										MONO.loaded_files.push((a = e, v.href = a, v.href)),
			...
			t.attachDebuggerHotkey = function (e) {
				...
				document.addEventListener("keydown", function (e) {
					var t;
					e.shiftKey && (e.metaKey || e.altKey) && "KeyD" === e.code && (a ? o ? ((t = document.createElement("a")).href = "framework/debug?url=" + encodeURIComponent(location.href), t.target = "_blank", t.rel = "noopener noreferrer", t.click()) : console.error("Currently, only Chrome is supported for debugging.") : console.error("Cannot start debugging, because the application was not compiled with debugging enabled."))
				})
			}
		}, function (e, t, n) {
			"use strict";
